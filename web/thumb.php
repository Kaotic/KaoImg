...
<div class="container-fluid bg-2 text-center">
    ...
    <a href="/<?= $image ?>" class="btn btn-success btn-lg">
        <span class="glyphicon glyphicon-link"></span> Lien direct
    </a>
    <a href="/delete/<?= $image ?>" class="btn btn-warning btn-lg">
        <span class="glyphicon glyphicon-remove"></span> Suppression
    </a>
</div>
